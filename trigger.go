...
// TriggerSeverity define the available levels of severity for a trigger.
type TriggerSeverity string

// TriggerState define the available types of state for a trigger.
type TriggerState string

// TriggerStatus define the available types of status for a trigger.
type TriggerStatus string

// TriggerMultipleEvents define if a trigger can generate multiple events.
type TriggerMultipleEvents string

// TriggerValue define the available types of value for a trigger.
type TriggerValue string

// TriggerRecoveryMode define the available types of recovery mode for a trigger.
type TriggerRecoveryMode string

// TriggerCorrelationMode define the available types of correlation mode for a trigger.
type TriggerCorrelationMode string

// TriggerManualClose define a trigger can be manually closed.
...
const (
	...
	TriggerDontGenerateMultipleEvents TriggerMultipleEvents = "0"
	TriggerGenerateMultipleEvents     TriggerMultipleEvents = "1"
	...
	TriggerManualCloseNo  TriggerManualClose = "0"
	TriggerManualCloseYes TriggerManualClose = "1"
)

// Trigger properties.
type Trigger struct {
	Id                 string                 `json:"triggerid,omitempty"`
	...
	Type               TriggerMultipleEvents  `json:"type,omitempty"`
	Url                string                 `json:"url,omitempty"`
	Value              TriggerValue           `json:"value,omitempty"`
